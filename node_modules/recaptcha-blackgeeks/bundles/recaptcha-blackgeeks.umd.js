(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('rxjs/add/observable/interval'), require('@angular/forms')) :
	typeof define === 'function' && define.amd ? define('recaptcha-blackgeeks', ['exports', '@angular/core', '@angular/common', 'rxjs/add/observable/interval', '@angular/forms'], factory) :
	(factory((global['recaptcha-blackgeeks'] = {}),global.ng.core,global.ng.common,global.Rx.Observable,global.ng.forms));
}(this, (function (exports,core,common,interval,forms) { 'use strict';
...
var RecaptchaComponent = /** @class */ (function () {
    ...
    RecaptchaComponent.prototype.reset = function () {
        ...
        this.enterText = '';
        var elementList = document.getElementsByClassName('text-wrapper');
        var iterateList = [].slice.call(elementList);
        try {
            for (var iterateList_1 = __values(iterateList), iterateList_1_1 = iterateList_1.next(); !iterateList_1_1.done; iterateList_1_1 = iterateList_1.next()) {
                var element = iterateList_1_1.value;
            ...
            try {
                if (iterateList_1_1 && !iterateList_1_1.done && (_a = iterateList_1.return)) _a.call(iterateList_1);
            }
...
RecaptchaComponent.decorators = [
    { type: core.Component, args: [{
                ...
                styles: ["@import url(https://fonts.googleapis.com/css?family=Caveat+Brush);.recaptcha-wrap{width:250px;background-color:#ebebec;border-radius:5px;-webkit-box-shadow:2px 2px 5px #888;box-shadow:2px 2px 5px #888;display:table-cell}.recaptcha-wrap p{width:50%;font-family:'Caveat Brush',cursive;margin:5px 0 0 5px;background:center/cover no-repeat #fff;border-radius:5px;text-align:center;padding:10px 20px;color:#80807f;font-size:35px;font-weight:900;display:inline-block;letter-spacing:2px;cursor:not-allowed;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;border:1px solid #d3d3d3;height:100%}.recaptcha-wrap i:before{content:'\uD83D\uDDD8';border:2px outset #5bc0de;background-color:#5bc0de;border-radius:5px;color:#fff;font-size:35px;font-weight:700;cursor:pointer;font-style:normal;display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;margin-top:5px;padding:4px 10px;width:15%}.recaptcha-wrap input[type=text]{display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;margin:5px;padding:5px 10px;width:58%;font-size:15px;color:#000;text-align:center;border-radius:5px}"]
            },] },
];
RecaptchaComponent.ctorParameters = function () { return [
    { type: Object, decorators: [{ type: core.Inject, args: [core.PLATFORM_ID,] },] },
]; };
var BlackgeeksRecaptchaModule = /** @class */ (function () {
...
exports.BlackgeeksRecaptchaModule = BlackgeeksRecaptchaModule;
exports.RecaptchaComponent = RecaptchaComponent;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=recaptcha-blackgeeks.umd.js.map
