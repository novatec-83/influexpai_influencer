...
var SettingsComponent = (function () {
    ...
    SettingsComponent.prototype.Subscribe = function () {
        if (this.switch) {
            this.srvc_obj.do_SubsCribe().subscribe(function (data) {
                // alert('Subscribe ....');
                __WEBPACK_IMPORTED_MODULE_5_sweetalert2___default()('You are Subscribed Successfully', '', 'success');
            });
        }
        else if (this.switch = true) {
            this.srvc_obj.do_UnSubsCribe().subscribe(function (data) {
                console.log('data is', data);
                __WEBPACK_IMPORTED_MODULE_5_sweetalert2___default()('You are now Unsubscribed', '', 'success');
            });
        }
    };
    ...
    SettingsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__app_service__["a" /* App_service */], __WEBPACK_IMPORTED_MODULE_2__angular_http__["Http"], __WEBPACK_IMPORTED_MODULE_3__serv_http_service__["a" /* HttpService */]])
    ], SettingsComponent);
