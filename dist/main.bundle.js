...
var App_service = (function () {
    ...
    App_service.prototype.register_user = function (username, name, first_name, last_name, email, password, country, relationship, education, phone, state, city, employment_status, gender) {
        var _this = this;
